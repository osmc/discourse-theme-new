  ...
  initialize() {
    withPluginApi("0.8.41", (api) => {
      try {
        ...
        osmcColoredLinks.push({ href: "https://osmc.tv/vero", className: "header-link big pink", label: "Vero 4K +" });
        osmcColoredLinks.push({ href: "https://my.osmc.tv/login/?redirect_to=https://my.osmc.tv/my-account/", className: "header-link big blue", label: "My Account" });
        ...
        osmcLinks.forEach((link) => {
            api.headerIcons.add("osmc", linkTemplate(link), { before: "search" });
        }});
